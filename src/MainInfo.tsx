...
const MainInfo = () => {
  return (
    <InfoContainer name="About Me">
      <div className="flex gap-3 flex-col mt-5 text-[#d6d6d6]">
        <div>
          I'm a full-stack developer based in Ottawa, Canada, with a passion for
          creating dynamic, efficient, and user-friendly web applications.
          Skilled in both front-end and back-end technologies, I build complete
          solutions that are visually appealing, intuitive, and highly
          functional.
        </div>
        <div>
          ...
          technologies like Node.js, Express, and MongoDB. This full-stack skill
          set allows me to develop and deploy applications from scratch, manage
          complex data flows, and optimize performance across all layers of the
          stack.
        </div>
        <div>
          ...
          high-quality applications that exceed expectations. Staying up-to-date
          with the latest industry trends and best practices, I continuously
          refine my skills to build efficient, maintainable, and
        ...
        <div className="w-full flex flex-col md:flex-row gap-3 flex-wrap items-center">
          ...
          <div className="bg-[#2b2b2cbf] w-auto md:w-[25rem] h-[150px] rounded-2xl p-5 flex items-center gap-5">
            ...
            <div>
              ...
              <div className="font-light text-xs md:text-sm mt-1">
                Experienced in designing applications with seamless integration
